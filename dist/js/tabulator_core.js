		...
		if (rowIndex > -1) {
			...
			switch (_this2.renderMode) {
				case "classic":
					...
					break;
				case "virtual":
					scrollOffset = _this2._virtualRenderFill(rowIndex, true);
					break;
			}
			...
			switch (position) {
				case "middle":
				case "center":
					_this2.element.scrollTop = _this2.element.scrollTop - _this2.element.clientHeight / 2 + scrollOffset;
					break;

				case "bottom":
					_this2.element.scrollTop = _this2.element.scrollTop - _this2.element.clientHeight + rowEl.offsetHeight + scrollOffset;
					break;
			}
